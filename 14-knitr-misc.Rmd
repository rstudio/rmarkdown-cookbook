...
If you do not have to specify the object name in `load_cache()` in the second argument, the whole cache database will be loaded into the current environment, and you can use any objects cache database before these objects are created later in the document, e.g.,
