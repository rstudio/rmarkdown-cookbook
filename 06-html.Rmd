...
We strongly recommend that you learn some CSS and JavaScript if you wish to customize the appearance of HTML documents. The [Appendix B](https://bookdown.org/yihui/blogdown/website-basics.html) of the **blogdown** book [@xie2017] contains short tutorials on HTML, CSS, and JavaScript.
...
If you want to specify different maximum heights for individual code blocks, you may see the example in Section \@ref(hooks-scroll).
