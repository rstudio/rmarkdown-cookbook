...
````
`r ''````{r df-drop, class.source='bg-warning', class.output='bg-warning'}
mtcars[, "mpg"]
```
````
...
````
`r ''````{r df-drop-ok, class.source='bg-success', class.output='bg-success'}
...
`r ''````{r df-drop-2, class.source='chunk-style'}
mtcars[, "mpg"] 
``` 
````
