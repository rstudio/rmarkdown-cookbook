...
You can add line numbers to either source code blocks via the chunk option `attr.source = ".numberLines"` or text output blocks via `attr.output = ".numberLines"` (see Section \@ref(attr-output) for more information on these options), e.g.,
