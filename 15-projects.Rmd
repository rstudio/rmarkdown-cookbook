...
For RStudio users, the easiest way to get started is to create a **bookdown** project from `File -> New Project -> New Directory -> Book Project using bookdown`, as you can see from Figure \@ref(fig:bookdown-project).
