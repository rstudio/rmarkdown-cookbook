...
There is a wealth of guidance which has grown over the past few years. [*R Markdown: The Definitive Guide*](https://bookdown.org/yihui/rmarkdown/) [@xie2018]. However, as noted by Yihui, it was commented by the publisher that it would be beneficial to provide more practical examples of the use of R Markdown. And so, the idea of this book was born.
...
It is recommended that readers have a basic understanding of R Markdown. [Chapter 2](https://bookdown.org/yihui/rmarkdown/basics.html) of [*R Markdown: The Definitive Guide*](https://bookdown.org/yihui/rmarkdown/) [@xie2018] provides a great overview of the basics of R Markdown.
...
- *R Markdown: The Definitive guide* [@xie2018]: provides an overview of the R Markdown package and the 
- *Dynamic documents and knitr*: provides further guidance on the inner workings of **knitr** [@R-knitr].
- *Authoring books with bookdown* [@xie2016bookdown]:
- *blogdown: Creating Websites with R Markdown*: [@xie2017blogdown]
...
```{r tidy=FALSE}
xfun::session_info(c(
  'blogdown', 'bookdown', 'knitr', 'rmarkdown'), dependencies = FALSE)
```
