...
You can register a custom language engine\index{language engine!custom} via the `knitr::knit_engines$set()`\index{knitr!knit\_engines} method, which accepts a function as its input, e.g.,
