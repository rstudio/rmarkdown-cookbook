...
Emily frequently discusses R on Twitter (https://twitter.com/emilyriederer) and her blog (https://emilyriederer.netlify.app/) and shared projects, including her **projmgr** R package, on GitHub (https://github.com/emilyriederer). She has also served as a package reviewer for rOpenSci and a founding co-organizer of the annual satRday Chicago R conference. 
