...
In this chapter, we introduce some tips on working with individual R Markdown documents as well as running your R Markdown projects. You may also check out [Chapter 30](https://r4ds.had.co.nz/r-markdown-workflow.html) of the book "R for Data Science" [@wickham2016], which briefly introduced some tips on using analysis notebooks (including R Markdown documents).
