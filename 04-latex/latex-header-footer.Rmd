...
This could be inserted in the document, or another _header.tex_ file :
...
If in an external _.tex_ file, then it could be included in the header of our `rmarkdown::pdf_document` format:
...
The _includes_ feature of `pdf_document` is presented in [Advanced customisation](https://bookdown.org/yihui/rmarkdown/pdf-document.html#includes-1) of @xie2018.
