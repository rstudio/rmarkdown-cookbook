...
```{r knitr-workflow, echo = FALSE, fig.cap = 'A flowchart of inputs and outputs to a language engine.', out.width = '100%', fig.dim=c(7, 3.5), fig.align='center'}
nomnoml::nomnoml(
  "
  [<frame>Code chunk|
...
```{r rmd-containers, echo = FALSE, fig.cap = 'A simple R Markdown document illustrated as a set of nested containers.', out.width = '50%', fig.align='center'}
nomnoml::nomnoml(
  "
  [Title (Level 1)|
