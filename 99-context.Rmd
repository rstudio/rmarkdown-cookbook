...
While much of our narrative is human-written, many R Markdown documents will likely wish to reference the code and analysis being used. For this reason, Chapter 3 (**TODO: How to reference without label?**) demonstrates the many ways that code can help generate parts of the text. This conversion is handled by `knitr` as we convert from `.Rmd` to `.md`.
