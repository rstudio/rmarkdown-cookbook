...
This feature is based on Pandoc's Lua filters. For those who are interested in the technology, you may view this package vignette:
...
Note that this feature requires at least Pandoc 2.8. You may check your Pandoc version via `rmarkdown::pandoc_version()`. If the version is lower than 2.8, you may install a newer version by following the instructions at https://pandoc.org/installing.html.
