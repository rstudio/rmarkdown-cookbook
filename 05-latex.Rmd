...
Pandoc converts Markdown to LaTeX through a template. The template is a LaTeX file containing Pandoc variables, and Pandoc will replace these variables with their values. Below is a simple template taht only contains a single variable `$body$`:
...
- `\leftmark`: thes name and number of the current top-level structure in uppercase letters.
