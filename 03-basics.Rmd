...
If you are not very familiar with Markdown yet, we recommend that you try the **remedy** package [@R-remedy], which has provided a series of RStudio addins to help you write Markdown content by clicking the addins. A GIF animation is worth a thousand words. Please check out its homepage for many GIFs that quickly shows you what this package can do.
