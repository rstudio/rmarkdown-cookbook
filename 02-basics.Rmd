...
This method of generating reports can be particularly useful when you primarily work with R scripts and do not need a lot of narratives. If the portion of text is substantial in your report, R Markdown may be a better choice, because you do not need to put all text in roxygen comments. When you need an R script from an R Markdown document, you can call the function `knitr::purl()` to extract code in the Rmd file to an R script.
