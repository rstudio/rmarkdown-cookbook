...
There are more than 50 chunk options that can be used to fine-tune the behavior of **knitr** when processing R chunks. A full description of available options and their behavior is available in Appendix \@ref(chunk-options-all) and online at <https://yihui.org/knitr/options/>.
